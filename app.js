        ...
        card.innerHTML = `
            <div class="recipe-header">
                ...
                <div class="button-group">
                    <button  class="button" onclick="toggleRecipe(${index})"><i class="fa fa-eye"></i></button>
                    <button class="button" onclick="editRecipe('${recipe.id}')"><i class='fa fa-pencil'></i></button>
                    <button class="button delete-button" onclick="deleteRecipe('${recipe.id}')"><i class='fa fa-trash'></i></button>
                </div>
            </div>
...
function editRecipe(id) {
    ...
    recipeContent.innerHTML = `
        ...
        <button class="button" onclick="addIngredientRow('${id}')"><i class='fa fa-plus'></i></button>
         <button class="button delete-button" onclick="removeLastIngredient('${id}')"><i class='fa fa-trash'></i></button>
        <h3>Process</h3>
